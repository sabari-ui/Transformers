...
- Feed-forward layers, residuals, and LayerNorm
- Masked self-attention and cross-attention
- Output probabilities and decoding
- Training, next-token prediction, and modern LLM implementation notes
...
Content is intended for open learning under Creative Commons Attribution 4.0.
Page code is available under the MIT License.
